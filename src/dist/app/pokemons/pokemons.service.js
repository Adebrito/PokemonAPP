...
var PokemonsService = /** @class */ (function () {
    ...
    PokemonsService.prototype.searchPokemons = function (term) {
        ...
        return this.http.get(this.pokemonsUrl + "/?name=" + term).pipe(operators_1.tap(function (_) { return _this.log("found pokemon matching \"" + term); }), operators_1.catchError(this.handleError('searchPokemons', [])));
    };
    // Retourne tous les pokémons
    PokemonsService.prototype.getPokemons = function () {
        var _this = this;
        return this.http.get(this.pokemonsUrl).pipe(operators_1.tap(function (_) { return _this.log('fetched pokemons'); }), operators_1.catchError(this.handleError('getPokemon', [])));
    };
    ...
    PokemonsService.prototype.deletePokemon = function (pokemon) {
        ...
        return this.http.delete(url, httpOptions).pipe(operators_1.tap(function (_) { return _this.log("deleted id=" + pokemon.id); }), operators_1.catchError(this.handleError('deletePokemon')));
    };
    PokemonsService.prototype.getPokemonTypes = function () {
        return ['Plante', 'Feu', 'Eau', 'Normal', 'Insecte', 'Electrique', 'Poison', 'Fée', 'Vol'];
    };
